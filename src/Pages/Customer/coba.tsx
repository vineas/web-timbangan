  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editSupplierCustomers) {
      ...
      if (error) {
        ...
        // reset
        setInsertKodeSupplierCustomers(0);
        setInsertSupplierCustomers("");
        setInsertAlamatSupplierCustomers("");
        setInsertKotaSupplierCustomers("");
        setInsertTeleponSupplierCustomers(0);
        setInsertFacsimileSupplierCustomers(0);
      ...
      <div className="p-6 bg-white shadow-sm rounded-lg">
        ...
        <div className="my-6">
          <form
            ...
            className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-8"
          >
            {/* Buttons */}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setInsertKotaSupplierCustomers(e.target.value)}
                id="kota"
                className="border-2 border-gray-300 text-gray-900 text-sm rounded-full 
              focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-3
              hover:border-gray-400 transition-colors duration-200"
              ...
              <input
                ...
                value={
                  insertTeleponSupplierCustomers !== null
                    ? insertTeleponSupplierCustomers.toString().padStart(9, "0")
                    : ""
                }
                onChange={(e) =>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInsertFacsimileSupplierCustomers(parseInt(e.target.value))
                }
                id="facsimile"
                className="border-2 border-gray-300 text-gray-900 text-sm rounded-full 
              focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-3
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setInsertPICSupplierCustomers(e.target.value)}
                id="pic"
                className="border-2 border-gray-300 text-gray-900 text-sm rounded-full 
              focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-3
              hover:border-gray-400 transition-colors duration-200"
